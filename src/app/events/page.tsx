        ...
        {showFilters && (
          <div className="lg:hidden flex flex-col gap-4">
            ...
            <button
              ...
              className="text-black dark:text-white bg-[#E2E5E9] dark:bg-neutral-800 px-6 py-2 rounded-md text-sm font-bold transition self-center hover:bg-[#DADDE1] dark:hover:bg-neutral-700"
            >
              Reset
            </button>
          </div>
